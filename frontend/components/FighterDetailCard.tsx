...
export const FighterDetailCard = ({ fighter }: { fighter: any }) => {
  ...
  return (
    <Link href={`/fighter/${fighter._id}`}>
      <div className="p-4 rounded-2xl bg-white/7 border border-[#ffffff36] hover:translate-y-[-5px] hover:bg-white/15 transition-all duration-300 cursor-pointer">
